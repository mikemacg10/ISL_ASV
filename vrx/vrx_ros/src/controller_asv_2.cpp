...
public:
    USVMovementNode() : Node("usv_simple_movement") {
        ...
        goals.push_back({-4400, 4700});
        goals.push_back({-4000, 4700});
        goals.push_back({-3800, 5000});
        goals.push_back({-3500, 5000});
        goal_number = 0;
        latest_bearing_ = 0.0;
        latest_range_ = 0.0;
        search_number = 1;
        ...
        w1_left_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv_m_2/thrusters/left/thrust", 1);
        w2_right_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv_m_2/thrusters/right/thrust", 1);
        angle_r1_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv_m_2/thrusters/left/pos", 1);
        angle_r2_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv_m_2/thrusters/right/pos", 1);

        // Initialize subscribers
        range_boat_subscriber = this->create_subscription<ros_gz_interfaces::msg::ParamVec>(
            "/wamv_m_2/sensors/acoustics/receiver/range_bearing", 1,
        ...
        pose_boat_subscriber = this->create_subscription<nav_msgs::msg::Odometry>(
            "/wamv_m_2/sensors/position/ground_truth_odometry", 1,
