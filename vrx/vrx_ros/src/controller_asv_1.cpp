...
public:
    USVMovementNode() : Node("usv_simple_movement") {
        ...
        // goals.push_back({-4700, -5000});
        // goals.push_back({-4400, -4500});
        // goals.push_back({-4000, -4500});
        // goals.push_back({-3500, -4000});
        // goals.push_back({-3300, -4000});
        goals.push_back({-200, 1000});
        ...
        w1_left_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv/thrusters/left/thrust", 1);
        w2_right_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv/thrusters/right/thrust", 1);
        angle_r1_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv/thrusters/left/pos", 1);
        angle_r2_pub_1 = create_publisher<std_msgs::msg::Float64>("/wamv/thrusters/right/pos", 1);

        // Initialize subscribers
        range_boat_subscriber = this->create_subscription<ros_gz_interfaces::msg::ParamVec>(
            "/wamv/sensors/acoustics/receiver/range_bearing", 1,
        ...
        pose_boat_subscriber = this->create_subscription<nav_msgs::msg::Odometry>(
            "/wamv/sensors/position/ground_truth_odometry", 1,
...
private:
    ...
    void thursterController()
    {
        ...
        cout<<"THURST "<< thurst_velo_left_ << endl;
        cout<<"THURST "<< thurst_velo_right_ << endl;
